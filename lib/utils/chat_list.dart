...
List<Chat> chats = [
  ...
  Chat(message: 'Hi how are you?', doctor: 'Maxmillan', dateTime: 'Friday', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80', hasStory: false, isOnline: true, messageType: 'receiver'),
  ...
  Chat(message: 'Bye', doctor: 'Laura', dateTime: '5 Oct', image: 'https://images.pexels.com/photos/6098057/pexels-photo-6098057.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2', hasStory: false, isOnline: false, messageType: 'receiver'),
];
